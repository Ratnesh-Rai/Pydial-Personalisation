...
class SimulationSystem(object):
    ...
    def run(self, session_id, agent_id='Smith', sim_level='dial_act', upfront_knowledge=None):
        '''
        ...
        for domain in self.simulator.simUserManagers:
            if self.simulator.simUserManagers[domain] and self.sim_level != 'sys2text':
                ...
                upfront_knowledge = self.simulator.simUserManagers[domain].um.hdcSim.upfront_knowledge
