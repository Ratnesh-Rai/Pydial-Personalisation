...
class BeliefTracker(object):
    ...
    def _updateBelief(self, turn, upfront_knowledge):
        '''
    ...
    def update_belief_state(self, lastact, obs, constraints=None, upfront_knowledge=None):
        '''
        ...
        last_feature = None
        logger.debug('Update to belief state')
        ...
        self.prevbelief = self._updateBelief(curturn, upfront_knowledge=upfront_knowledge)
#         self._print_belief()
