...
class BeliefTrackingManager(object):
    ...
    def update_belief_state(self, dstring, lastSysAct, inputActs, constraints, upfront_knowledge=None):
        '''
        Update belief state given infos
        '''
        logger.debug(self.domainBeliefTrackers[dstring])
        return self.domainBeliefTrackers[dstring].update_belief_state(lastSysAct, inputActs, constraints, upfront_knowledge)
