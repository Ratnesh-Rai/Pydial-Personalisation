...
class SemanticBeliefTrackingManager(object):
    ...
    def update_belief_state(self, dstring, ASR_obs, sys_act, turn=None, hub_id=None,
            sim_lvl='dial_act', upfront_knowledge=None):
        '''
        ...
        self.state.domainStates[dstring] = self.domainSemiBelieftrackers[dstring].update_belief_state(ASR_obs, sys_act,
                self.constraints, turn, hub_id, sim_lvl, upfront_knowledge=upfront_knowledge)
