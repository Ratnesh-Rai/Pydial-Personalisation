...
class DactItem(object):
    ...
    def match(self, other):
        ...
        logger.debug(self.val)
        logger.debug(other.val)
        if self.val is None and other.val is None:
            return False
        elif self.val is None or other.val is None:
            logger.error('None value is given in comparison between {} and {}'.format(str(self),
                str(other)))
